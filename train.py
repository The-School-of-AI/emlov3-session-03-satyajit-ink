...
def main():
    ...
    parser.add_argument("--save-dir", default="./", help="checkpoint will be saved in this directory")
    ...
    saved_ckpt.parent.mkdir(parents=True, exist_ok=True)
    if saved_ckpt.exists():
        ...
        last_ckpt = Path(args.save_dir) / "model" / "model_checkpoint.pth"
        if args.resume:
